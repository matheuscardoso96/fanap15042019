 ...
 * @author T-Gamer
 */
public class VisaoPais extends javax.swing.JFrame {
    ...
    private void jbtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtSalvarActionPerformed
        checarChave();
        ControlePais pc = new ControlePais();
        int chavePrimaria = pc.insert((Pais)criarPais());
    ...
    private void jbtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtExcluirActionPerformed
        ...
        if (opcao == 0) {
            ControlePais pc = new ControlePais();
            int chavePrimaria = pc.delete((Pais)criarPais());
            popularChave(Integer.toString(chavePrimaria));
        }
    ...
    private void jbtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtAlterarActionPerformed
        ...
        if (opcao == 0) {
        ControlePais pc = new ControlePais();
        int chavePrimaria = pc.update((Pais)criarPais());
        popularChave(Integer.toString(chavePrimaria));
        }
    ...
    private void jbtBuscaCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtBuscaCodigoActionPerformed
        ControlePais pc = new ControlePais();
        Pais p =(Pais)pc.selectCodigo(Integer.parseInt(jtfCodigo.getText()));
        popularCampos(Integer.toString(p.getCodigo()),p.getDescricao());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisaoPais.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
