 ...
 * @author T-Gamer
 */
public class VisaoTipoPessoa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Manter Tipo Pessoa");
    ...
    private void jbtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtSalvarActionPerformed
        ...
        int chavePrimaria = ctp.insert((TipoPessoa)criarTipoPessoa());
    ...
    private void jbtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtExcluirActionPerformed
        ...
        if (opcao == 0) {
            ControleTipoPessoa ctp = new ControleTipoPessoa();
            int chavePrimaria = ctp.delete((TipoPessoa)criarTipoPessoa());
            popularChave(Integer.toString(chavePrimaria));
        }
    ...
    private void jbtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtAlterarActionPerformed
        ...
        if (opcao == 0) {
            ControleTipoPessoa ctp = new ControleTipoPessoa();
        int chavePrimaria = ctp.update((TipoPessoa)criarTipoPessoa());
        popularChave(Integer.toString(chavePrimaria));
        }
    ...
    private void jbtBuscaCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtBuscaCodigoActionPerformed
        ControleTipoPessoa ctp = new ControleTipoPessoa();
        TipoPessoa tp =(TipoPessoa)ctp.selectCodigo(Integer.parseInt(jtfCodigo.getText()));
    ...
    private Object criarTipoPessoa() {
        int codigo = Integer.parseInt(jtfCodigo.getText());
        String descricao = jtfDescricao.getText();
        TipoPessoa tipoPessoa = new TipoPessoa(codigo, descricao);
        return tipoPessoa;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisaoTipoPessoa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisaoTipoPessoa().setVisible(true);
            }
        });
    }
